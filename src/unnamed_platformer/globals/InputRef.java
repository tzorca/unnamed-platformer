...
public final class InputRef {
	...
	public enum GameKey {
		left, right, up, down, a, b, start, scrollIn, scrollOut, sizePlus, sizeMinus, restartApp, toggleFullscreen, changeResTest, saveTempGame, saveScreenshot, menuBack
	}
	...
	static {
		...
		dgk.put(Input.KEY_F3, new PlayerGameKey(1, GameKey.changeResTest));
