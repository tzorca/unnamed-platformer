...
public class Control_PersistentVectorMovement extends ControlMechanism {
	...
	public Control_PersistentVectorMovement(ActiveEntity actor, double speed, double angle) {
		super(actor);
		this.vector = MathHelper.vectorFromAngleAndSpeed(speed, angle);
	}

	public Control_PersistentVectorMovement(ActiveEntity actor, Vector2f vector, long duration) {
		super(actor);
		this.vector = vector;
